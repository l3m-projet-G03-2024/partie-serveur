package fr.uga.l3miage.integrator.cyberProduit.exceptions.handlers;

import fr.uga.l3miage.integrator.cyberProduit.errors.*;
import fr.uga.l3miage.integrator.cyberProduit.exceptions.rest.*;
...
@Slf4j
@ControllerAdvice
public class CyberProduitsExceptionRestHandler {
